export const categories = [
  {
    ...
    sessions: [
      ...
      },
      {
        ...
        desc: "A new house in 24 hours can this be our practical solution for making affordable housing for all? See what has been done in this very vertical industry, and discuss how it will grow and be truly affordableâ€”both for those living in the homes, and for the builders that create them.",
        speaker: {
          name: "Griffin Snow",
          title: "Urban Planner",
          org: "KinetEco Inc.",
    ...
    sessions: [
      {
        ...
        desc: "Eliminating human error and saving time and money are key reasons user testingâ€”at least parts of itâ€”is an ideal job for automation. We'll discuss the advantages and disadvantages of using machines to test a product that will be used by humans.",
        speaker: {
          name: "Ally Bode",
          title: "UX Designer",
    ...
    sessions: [
      {
        ...
        desc: "The aspects of the learning experience continually changes, and has been forced to take some giant leaps in this past year. Learn how to develop new technology and experiences while keeping in mind that the end â€œproductâ€ is a human that is counting on you to learn.",
        speaker: {
          name: "Aran Nguyen",
          title: "LEX Designer",
          org: "Binaryville",
    ...
    sessions: [
      {
        ...
        desc: "There is a maker inside of each of usâ€”and some get out more often than others. From innovating a way to make a job easier, to renovating a tired chest of drawers into a piece of statement home decor, bits of maker make it into our days on a regular basis. Here's how to embrace and encourage that maker in everyone around us.",
        speaker: {
          name: "Jenny Torres",
          title: "Account Executive",
          org: "Red30 Tech",
    ...
    sessions: [
      ...
      },
      {
        ...
        speaker: {
          ...
          org: "Leaf & Mortar",
          bio: "Victor Gonzalez has worked tirelessly in helping organizations design and model systems that bring normally 'hidden' infrastructuresâ€”such as the wastewater management systems he designs and implementsâ€”to life using virtual reality.",
        },
      },
    ],
  },
